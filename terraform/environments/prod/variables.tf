...
variable "cluster_version" {
  description = "Kubernetes version for the EKS cluster (e.g. \"1.34\"). Pin this to avoid unexpected upgrades."
  type        = string
}
...
variable "elasticache_automatic_failover_enabled" {
  description = "Enable automatic failover for ElastiCache Redis. Requires num_cache_nodes >= 2. false for Dev, true for Prod."
  type        = bool
  default     = false
}
